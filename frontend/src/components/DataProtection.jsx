        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <Link to="/" className="flex items-center">
              <img src={dormoSmallIcon} alt="Dormo" className="h-10" />
            </Link>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-2 mb-6 border border-white/20">
              ...
              <span className="text-white/90 text-sm font-medium">CCBC Students Data Protection</span>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
            ...
            <div className="mb-12">
              ...
              <p className="text-white/80 leading-relaxed">
                Dormo ("we," "our," or "us") is committed to protecting the privacy and security of CCBC students who use our student marketplace application. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and related services.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-3">Marketplace Data</h3>
                  <ul className="text-white/80 space-y-2 ml-4">
                    <li>• Items listed for sale and purchase history</li>
                    <li>• Transaction details and communication records</li>
            ...
            <div className="mb-12">
              ...
              <ul className="text-white/80 space-y-3 ml-4">
                <li>• <strong>Facilitate Transactions:</strong> Enable buying and selling between verified CCBC students</li>
                <li>• <strong>Ensure Safety:</strong> Verify student status and maintain a secure marketplace environment</li>
                <li>• <strong>App Functionality:</strong> Enable core features like item listings, messaging, and transaction history</li>
                <li>• <strong>Student Verification:</strong> Verify CCBC student status through institutional email</li>
                <li>• <strong>Support Services:</strong> Provide customer support and resolve transaction disputes</li>
                <li>• <strong>App Improvement:</strong> Analyze usage patterns to enhance marketplace features and performance</li>
                <li>• <strong>Communication:</strong> Send important updates, transaction notifications, and marketplace tips</li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                ...
                <ul className="text-white/80 space-y-2 ml-4">
                  ...
                  <li>• Your marketplace activity remains private and is not used for academic evaluation</li>
                  <li>• We may share anonymized, aggregated marketplace trends for research purposes only with explicit consent</li>
                  <li>• Student email verification is used solely for marketplace access control</li>
      ...
      <footer className="bg-black/20 backdrop-blur-md border-t border-white/20 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center mb-4">
            <img src={dormoSmallIcon} alt="Dormo" className="h-8" />
          </div>
          <p className="text-white/70 text-sm">
            © {new Date().getFullYear()} All rights reserved. • Designed for CCBC Students
          </p>
        </div>
      </footer>
    </div>
